...
Of course, in practice, you're not goint to do that. You are going to compress an archive one time, and you are going to keep that compressed file. When you want to decompress, you should still keep a copy of the compressed file for later. Think of it as making decompressed copies of the compressed file from now on.
